...
[_BL] = KEYMAP(
  ...
  LSFT(KC_L), KC_A,      KC_S,    KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,    KC_SCLN,  KC_QUOT,  KC_NUHS,   KC_ENT,                                     \
...
void matrix_scan_user(void) {
  LEADER_DICTIONARY() {
    ...
    SEQ_TWO_KEYS(KC_H, KC_O){ \\ <leader>h-o  opens chat and types hideout for PoE
      TAP_ONCE(KC_ENT);
      SEND_STRING("/hideout");
      TAP_ONCE(KC_ENT);
    }
